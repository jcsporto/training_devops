module "ec2_control_plane_instances" {
  ...
  auto_scaling_group = {
    ...
    instance_maintenance_policy = {
      min_healthy_percent = var.control_plane_auto_scaling_group.instance_maintenance_policy.min_healthy_percent
      max_healthy_percent = var.control_plane_auto_scaling_group.instance_maintenance_policy.max_healthy_percent
    }
  }
  tags = var.tags
}
